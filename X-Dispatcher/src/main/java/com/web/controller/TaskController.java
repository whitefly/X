...
import static com.exception.ErrorCode.SERVICE_TASK_NOT_EXIST;
...
public class TaskController {
    ...
    public ResponseVO taskList() {
        List<TaskDO> tasks = taskService.getTasks();
        return new ResponseVO(tasks);
    }
